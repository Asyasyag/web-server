...
$labs = [
  ...
  ['course-work/www/', 'Курсовая работа', 'Проект «Накопления на лето»: MVC, CRUD и калькулятор достижения цели 67 000 ₽'],
];
?>
<!doctype html>
<html lang="ru">
...
<body>
  <div class="shell">
    ...
    <section class="hero">
      <p class="meta">Единый проект в общем pastel-стиле: все лабораторные работы и курсовая собраны в одном месте и оформлены в одной визуальной теме.</p>
      <h2>Лабораторные работы и курсовая</h2>
      <p>Здесь собраны все выполненные задания по дисциплине: от базовых PHP-страниц и форм до мини-MVC, CRUD и итоговой курсовой работы «Накопления на лето».</p>
    </section>
