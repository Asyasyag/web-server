...
$labs = [
  ...
  ['course-work/www/', 'Курсовая работа', 'Мини-приложение «Кулинарная книга»: MVC, CRUD и расчёт калорийности'],
];
?>
<!doctype html>
<html lang="ru">
...
<body>
  <div class="shell">
    ...
    <section class="hero">
      <h2>Сервер с лабораторными работами и курсовой</h2>
      <p>Все лабораторные работы и курсовая собраны в один проект. Внешний вид переработан: новая цветовая схема, карточное меню, единая навигация и обновлённая структура файлов.</p>
    </section>
